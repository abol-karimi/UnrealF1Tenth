...
#include "F1TenthWheelFront.h"
#include "F1TenthWheelRear.h"
...
const FName AF1TenthPawn::LookUpBinding("LookUp");
const FName AF1TenthPawn::LookRightBinding("LookRight");
const FName AF1TenthPawn::EngineAudioRPM("RPM");

#define LOCTEXT_NAMESPACE "VehiclePawn"

AF1TenthPawn::AF1TenthPawn()
{
	// Car mesh
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UF1TenthWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UF1TenthWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UF1TenthWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UF1TenthWheelRear::StaticClass();
...
void AF1TenthPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AF1TenthPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AF1TenthPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AF1TenthPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AF1TenthPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AF1TenthPawn::OnToggleCamera);

	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &AF1TenthPawn::OnResetVR); 
}

void AF1TenthPawn::MoveForward(float Val)
{
...
void AF1TenthPawn::MoveRight(float Val)
{
	GetVehicleMovementComponent()->SetSteeringInput(Val);
}

void AF1TenthPawn::OnHandbrakePressed()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(true);
}

void AF1TenthPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void AF1TenthPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void AF1TenthPawn::EnableIncarView(const bool bState)
{
...
void AF1TenthPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AF1TenthPawn::UpdateHUDStrings()
{
...
void AF1TenthPawn::SetupInCarHUD()
{
...
void AF1TenthPawn::UpdatePhysicsMaterial()
{
